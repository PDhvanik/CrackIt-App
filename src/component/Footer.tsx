...
export default () => {
   ...
   return (
      <footer className="pt-4 mt-48 bg-gray-800">
         <div className="max-w-screen-xl mx-auto px-4 md:px-8">
            <div className="justify-between items-center md:flex">
               <div className="flex-1 max-w-lg">
                  <h3 className="text-white text-2xl font-bold">
                     Get your Coding Efficiency straight to your inbox.
                  </h3>
               </div>
               <div className="flex-1  md:mt-0">
                  <form onSubmit={(e) => e.preventDefault()} className="flex items-center gap-x-3 md:justify-end">
                     ...
                     <button className="block w-auto py-2 px-3 font-medium text-sm text-center text-white bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-700 active:shadow-none rounded-lg shadow">
                        Subscribe
                     </button>
                  </form>
               </div>
            ...
            <div className="mt-8 ">
               <div className="text-md text-gray-300 ">"Unlock the power of code with our comprehensive tutorials and resources. Start your coding journey today!"</div>
               <div className="text-md text-gray-300 ">"Transform your ideas into reality with the right tools and knowledge. Explore our platform for all your coding needs."</div>
               <div className="text-md text-gray-300 ">"Join the coding revolution. Unleash your creativity and problem-solving skills with our guidance and support."</div>
            </div>
            <div className="mt-8 py-4 border-t border-gray-700 items-center justify-between sm:flex">
               <p className="text-gray-300">© 2022 CrackIT Inc. All rights reserved.</p>
               <div className="flex items-center gap-x-6 text-gray-400 mt-2">
